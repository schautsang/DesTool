...
private:
        ...
        char szFCiphertextAnyLength[1024 + 1];//任意长度密文
        char szFPlaintextAnyLength[1024 + 1];//任意长度明文字符串
